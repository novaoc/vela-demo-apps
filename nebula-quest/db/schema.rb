...
ActiveRecord::Schema[8.1].define(version: 2026_08_12_000001) do
  ...
  create_table "game_runs", force: :cascade do |t|
    ...
    t.integer "ore_collected", default: 0, null: false
    t.integer "score", default: 0, null: false
    t.string "ship_name", default: "Scout", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["score", "created_at"], name: "index_game_runs_on_score_and_created_at"
