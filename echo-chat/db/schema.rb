...
ActiveRecord::Schema[8.1].define(version: 2026_08_12_000001) do
  ...
  create_table "chat_canned_replies", force: :cascade do |t|
    t.text "body", null: false
    t.datetime "created_at", null: false
    t.bigint "organization_id", null: false
    t.string "title", null: false
    t.string "trigger_keywords", default: "", null: false
    t.datetime "updated_at", null: false
    t.index ["organization_id"], name: "index_chat_canned_replies_on_organization_id"
  end
  ...
  create_table "chat_conversations", force: :cascade do |t|
    ...
    t.string "subject", default: "New conversation", null: false
    t.datetime "updated_at", null: false
    t.string "visitor_email", default: "", null: false
    t.string "visitor_name", default: "Visitor", null: false
    t.index ["assignee_id"], name: "index_chat_conversations_on_assignee_id"
    t.index ["organization_id", "status"], name: "index_chat_conversations_on_organization_id_and_status"
  ...
  create_table "chat_messages", force: :cascade do |t|
    ...
    t.string "sender_type", default: "visitor", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id"
  ...
  add_foreign_key "chat_canned_replies", "organizations_organizations", column: "organization_id"
  add_foreign_key "chat_conversations", "organizations_organizations", column: "organization_id"
  add_foreign_key "chat_conversations", "users", column: "assignee_id"
