Rails.application.routes.draw do
  ...
  scope "chat", module: "chat", as: :chat do
    get "inbox", to: "inbox#show", as: :inbox
    resources :conversations, only: %i[show create update]
    resources :canned_replies, only: %i[create destroy]
    get "widget/:id", to: "widgets#show", as: :widget
    patch "widget/:id", to: "widgets#update"
  end
  root "chat/home#show"
