...
ActiveRecord::Schema[8.1].define(version: 2026_08_12_000001) do
  ...
  create_table "pokemon_cards", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "image_emoji", default: "🃏", null: false
    ...
    t.datetime "updated_at", null: false
    t.index ["set_name", "number"], name: "index_pokemon_cards_on_set_name_and_number", unique: true
  end
  ...
  create_table "portfolio_holdings", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["pokemon_card_id"], name: "index_portfolio_holdings_on_pokemon_card_id"
    t.index ["user_id", "pokemon_card_id"], name: "index_portfolio_holdings_on_user_id_and_pokemon_card_id", unique: true
  ...
  add_foreign_key "portfolio_holdings", "pokemon_cards"
